...
//   return (
//     <div className="max-w-sm w-full p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-pink-50 text-gray-800 shadow-md hover:shadow-xl transform transition duration-500 hover:-translate-y-2">
      
//       {/* Profile Image / Fallback */}
//       <div className="flex justify-center">
//         <div className="w-24 h-24 rounded-full border-4 border-white shadow-sm flex items-center justify-center text-3xl font-bold bg-blue-100 text-blue-700">
//           {image ? (
//             <img
//               src={image}
//               alt="User Avatar"
...
//         <h2 className="text-xl font-semibold text-gray-800">{name || "Unknown User"}</h2>
//         <p className="text-sm text-gray-500 mt-1">{email || "No email provided"}</p>
//       </div>

//       {/* Button */}
//       <div className="mt-6 flex justify-center">
//         <button className="px-6 py-2 bg-blue-400 text-white font-medium rounded-lg shadow hover:bg-blue-500 transition">
//           View Profile
//         </button>
//       </div>
//     </div>
